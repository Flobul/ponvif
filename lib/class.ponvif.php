...
class ponvif {
	...
	*/
	public function core_GetSystemDateAndTime() {
		...
		else return $response['Envelope']['Body']['GetSystemDateAndTimeResponse']['SystemDateAndTime']['UTCDateTime'];
	}
	...
	public function core_GetCapabilities() {
		...
		else return $response['Envelope']['Body']['GetCapabilitiesResponse']['Capabilities'];
	}
	...
	public function media_GetVideoSources() {
		...
		else return $response['Envelope']['Body']['GetVideoSourcesResponse']['VideoSources'];
	}
	...
	public function media_GetProfiles() {
		...
		else return $response['Envelope']['Body']['GetProfilesResponse']['Profiles'];
	}
	...
	public function core_GetDeviceInformation() {
		...
		else return $response['Envelope']['Body']['GetDeviceInformationResponse'];
	}
	...
	public function media_GetStreamUri($profileToken, $stream = "RTP-Unicast", $protocol = "RTSP") {
		...
		else return $response['Envelope']['Body']['GetStreamUriResponse']['MediaUri']['Uri'];
	}
	...
	public function ptz_GetNode($ptzNodeToken) {
		...
		else return $response['Envelope']['Body']['GetNodeResponse'];
	}
	...
	*/
	...
	protected function _send_request($url, $post_string) {
		...
		if ($this->proxyhost != '' && $this->proxyport != '') {
			...
			if ($this->proxyusername != '' && $this->proxypassword != '') curl_setopt($soap_do, CURLOPT_PROXYUSERPWD, $this->proxyusername . ':' . $this->proxypassword);
		}
